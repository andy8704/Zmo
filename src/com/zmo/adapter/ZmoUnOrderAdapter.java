...
public class ZmoUnOrderAdapter extends BaseAdapter {

	private Context mContext;
	private List<OrderInfo> mData;

	public ZmoUnOrderAdapter(Context context, final List<OrderInfo> data) {
		mContext = context;
		mData = data;
	}
	...
	public View getView(int position, View contentView, ViewGroup arg2) {
		...
		Holder holder = null;
		if (null == contentView) {
			contentView = LayoutInflater.from(mContext).inflate(R.layout.zmo_unordered_adapter, null);
		...
		if (null != model) {
			...
			holder.tv_CancelBtnView.setOnClickListener(new View.OnClickListener() {
				@Override
	...
	public class Holder {
		...
		public TextView tv_CancelBtnView;
		public TextView tv_PayBtn;
		...
		public Holder(final View view) {
			...
			tv_CancelBtnView = (TextView) view.findViewById(R.id.cancel_order_btn_id);
			tv_PayBtn = (TextView) view.findViewById(R.id.pay_btn_id);
		}
	}
