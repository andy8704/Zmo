...
public class ZmoCloseOrderAdapter extends BaseAdapter {

	private Context mContext;
	private List<OrderInfo> mData;

	public ZmoCloseOrderAdapter(Context context, final List<OrderInfo> data) {
		mContext = context;
		mData = data;
	}
	...
	public View getView(int position, View contentView, ViewGroup arg2) {
		...
		Holder holder = null;
		if (null == contentView) {
			contentView = LayoutInflater.from(mContext).inflate(R.layout.zmo_close_ordered_adapter, null);
		...
		if (null != model) {
			...
			holder.tv_DelView.setOnClickListener(new View.OnClickListener() {
				@Override
	...
	public class Holder {
		...
		public Holder(final View view) {
			...
			tv_DelView = (TextView) view.findViewById(R.id.del_order_btn_id);
		}
	}
