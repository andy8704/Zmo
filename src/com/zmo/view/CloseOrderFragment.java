...
import com.zmo.R;
import com.zmo.adapter.ZmoCloseOrderAdapter;
import com.zmo.model.OrderInfo;
import com.zmo.utils.NetWorkMonitor;

public class CloseOrderFragment extends BaseFragment implements IXListViewListener, OnItemClickListener {

	private PullListView mPullListView;
	private ZmoCloseOrderAdapter mAdapter = null;
	...
	protected void initView() {
		...
		mAdapter = new ZmoCloseOrderAdapter(getActivity(), mDataList);
	...
	private void onGetData() {
		...
		new Thread() {
			public void run() {
				synchronized (CloseOrderFragment.this) {
