...
import com.zmo.R;
import com.zmo.adapter.ZmoOrderAdapter;
import com.zmo.model.OrderInfo;
import com.zmo.utils.NetWorkMonitor;

public class PayedOrderFragment extends BaseFragment implements IXListViewListener, OnItemClickListener {

	private PullListView mPullListView;
	private ZmoOrderAdapter mAdapter = null;
	...
	protected void initView() {
		...
		mAdapter = new ZmoOrderAdapter(getActivity(), mDataList);
	...
	private void onGetData() {
		...
		new Thread() {
			public void run() {
				synchronized (PayedOrderFragment.this) {
