...
import com.zmo.CourseDetailActivity;
import com.zmo.R;
import com.zmo.adapter.CourseItemAdapter;
import com.zmo.model.CourseModel;
import com.zmo.utils.CommonDefine;
import com.zmo.utils.NetWorkMonitor;

public class CourseOfflineFragment extends BaseFragment implements IXListViewListener, OnItemClickListener {

	private PullListView mPullListView;
	private CourseItemAdapter mAdapter = null;
	...
	protected void initView() {
		...
		mDataList = new ArrayList<CourseModel>();
		mAdapter = new CourseItemAdapter(getActivity(), mDataList);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		if (arg2 >= 1) {
			CourseModel model = mDataList.get(arg2 - 1);
			if (null != model) {
	...
	private void onGetData() {
		...
		new Thread() {
			public void run() {
				synchronized (CourseOfflineFragment.this) {
