...
public class OnlineActivityFragment extends BaseFragment implements IXListViewListener, OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		if (arg2 >= 1) {
			...
			if (null != model) {
				Intent intent = new Intent(getActivity(), ActivityOnlineDetailActivity.class);
	...
	private void onGetData() {
		...
		new Thread() {
			public void run() {
				synchronized (OnlineActivityFragment.this) {
